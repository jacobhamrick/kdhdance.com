...
<main>
  <div class="main-body scroll">
    <div class="page-body <?php wp_title('', true,''); echo '-div'?>">
      ...
      <p style="text-align: center;">Zelle <i class="far fa-hand-point-right"></i> kathy@kdhdance.com</p>
      <p style="text-align: center;">Checks <i class="far fa-hand-point-right"></i> KDH Dance, 4703 Fieldstone Drive, Austin, TX 78735</p>
